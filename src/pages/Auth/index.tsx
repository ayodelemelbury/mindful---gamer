...
export function AuthPage() {
  ...
  const { setProfile, setAuthenticated, fetchFromCloud } = useUserStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfile({
        displayName: currentUser.displayName || displayName || 'Gamer',
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Get user info after Google sign-in
      const { auth } = await import('../../lib/firebase')
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Mindful Gamer</CardTitle>
          <CardDescription>
            {mode === 'login' 
